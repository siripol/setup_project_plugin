...
The `adversary` subagent runs after each spec-loop sprint and tries to falsify the invariants — any successful break commits a new failing test that catches the regression.
