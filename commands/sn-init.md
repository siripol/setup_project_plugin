---
name: sn-init
description: Scaffold a Claude-powered project (Tier 2 Agent SDK + Tier 3 Managed Agents), or add .claude/ scaffolding into an existing repo. Auto-detects mode from cwd. Use when the user invokes /sn-init or asks to init a project.
---
...
See `skills/sn-init/SKILL.md` for full design + `README.md` for plugin install.
